// File: sdk/types/event.go
// Purpose: Core MeshGuard data types — zero dependencies, imported by all packages
// Connects to: queue (persistence), engine (state machine), api (HTTP responses)
// Design: This package must never import any other meshguard package
...
// Transition changes status if valid
